...
resource "aws_route_table" "public" {
  ...
  tags = merge(
    {
      "Name" = format("${var.vpc_name}-rtb-${var.public_subnet_suffix}-%s", element(var.azs, count.index))
    },
    var.tags
  )
}
...
resource "aws_network_acl" "public" {
  ...
  tags = merge(
    {
      "Name" = "${var.vpc_name}-${var.public_subnet_suffix}-nacl"
    },
    var.tags
  )
}
...
resource "aws_route_table" "private" {
  ...
  tags = merge(
    {
      "Name" = format("${var.vpc_name}-rtb-${var.private_subnet_suffix}-%s", element(var.azs, count.index))
    },
    var.tags
  )
}
...
resource "aws_network_acl" "private" {
  ...
  tags = merge(
    { "Name" = "${var.vpc_name}-${var.private_subnet_suffix}-nacl" },
    var.tags
  )
}
