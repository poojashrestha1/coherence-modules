...
variable "name" {
  description = "The name of the queue. If omitted, Terraform will assign a random, unique name"
  type        = string
  default     = null
}
...
variable "kms_data_key_reuse_period_seconds" {
  description = "he length of time, in seconds, for which Amazon SQS can reuse a data key to encrypt or decrypt messages before calling AWS KMS again"
  type        = number
  default     = null
}
...
variable "create_dlq_redrive_allow_policy" {
  description = "Whether to create SQS queue redrive policy"
  type        = bool
  default     = false
}
